...
CATS = ["Стройматериалы","Отделочные материалы","Кровля","Водосточные системы","Фасадные системы","Фундамент",
        "Металлопрокат","Дерево и пиломатериалы","Инженерия","Электрика","Сантехника",
        "Крепёж и метизы","Инструмент и расходники","Мебель и отделка","Прочее"]

CATS_HINTS = """Подсказки по категориям:
- Кровля: металлочерепица, профнастил, ондулин, черепица, кровельные материалы, мембраны, ендова, конёк, снегозадержатель, фасонные элементы кровли
- Водосточные системы: желоб, труба водост., труба водосточная, "водост." = водосточная, держатель желоба, воронка, колено водосточное, заглушка желоба, угол желоба, водосточная система, слив, лоток водосточный, цветной круглый/прямоугольный (в контексте водостока)
- Фасадные системы: фасадная кассета, кассета ЮК, фасадная панель, сайдинг, облицовочная панель, вентфасад, фасадный профиль, подсистема фасадная, кронштейн фасадный, направляющая фасадная, фиброцементная панель, композитная панель, HPL панель
- Фундамент: бетон, раствор, цемент, плита перекрытия, блок фундаментный, арматура фундамент, опалубка
- Металлопрокат: арматура, уголок, швеллер, двутавр, балка, труба металлическая, профильная труба, лист металлический
- Дерево и пиломатериалы: доска, брус, фанера, OSB, вагонка, пиломатериал, рейка, черенок
- Крепёж и метизы: саморез, гвоздь, болт, гайка, шайба, анкер, дюбель, заклепка, скоба, шуруп
- Инструмент и расходники: диск, бита, валик, кисть, ведро, ванночка, пистолет для пены, перчатки, леска, карандаш
- Электрика: кабель, провод, автомат, выключатель, розетка, бокс щитовой, изолятор, УЗО
- Сантехника: труба канализационная, тройник, отвод, муфта, люк, колодец, НПВХ
- Инженерия: утеплитель, пароизоляция, гидроизоляция, пена монтажная, герметик, мастика, пленка
- Отделочные материалы: краска, грунтовка, шпаклёвка, штукатурка, плитка, ламинат, линолеум, обои, наливной пол
- Стройматериалы: кирпич, блок газобетонный, блок керамический, пеноблок, шлакоблок, песок, щебень, гравий"""
