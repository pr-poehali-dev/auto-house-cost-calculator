...
const CATS = ["Стройматериалы","Отделочные материалы","Кровля","Водосточные системы","Фундамент","Металлопрокат","Дерево и пиломатериалы","Инженерия","Электрика","Сантехника","Крепёж и метизы","Инструмент и расходники","Мебель и отделка","Прочее"];
